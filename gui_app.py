...
class Insta360ConvertGUI(tk.Tk):
    ...
    def create_widgets(self): # pylint: disable=too-many-statements
        ...
        self.realityscan_pose_in_common_check.grid(row=6, column=0, columnspan=4, padx=5, pady=2, sticky=tk.W)
        ...
        self.realityscan_editor_options_check.grid(row=7, column=0, columnspan=4, padx=5, pady=2, sticky=tk.W)
    ...
    def update_ui_texts_for_language_switch(self): # pylint: disable=too-many-statements
        ...
        self.realityscan_preset_options_map = {
            ...
            S.get("realityscan_preset_cli_rewrite"): "cli_rewrite",
