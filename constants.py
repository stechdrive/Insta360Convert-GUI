...
# --- バージョン情報 ---
APP_RELEASE_DATE = "2026-01-01" # リリース日 (ユーザー提供の値を維持)
...
# --- RealityScan関連定数 ---
REALITYSCAN_DEFAULT_XMP_MODE = "draft"
REALITYSCAN_DEFAULT_RIG_ID_MODE = "auto"
REALITYSCAN_DEFAULT_RIG_INSTANCE_MODE = "per_frame"
REALITYSCAN_DEFAULT_CALIBRATION_PRIOR = "locked"
REALITYSCAN_DEFAULT_CALIBRATION_GROUP_MODE = "per_camera"
REALITYSCAN_DEFAULT_DISTORTION_MODEL = "brown3"
REALITYSCAN_DEFAULT_COORDINATES = "relative"
