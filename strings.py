    ...
    def __init__(self, initial_language='ja'): # デフォルトを 'ja' から initial_language へ変更
        ...
        self._strings = {
            'ja': {
                ...
                "glomap_exec_label": "GLOMAP実行ファイル:",
                "glomap_exec_tooltip": "glomap.exe (またはglomap) のパスを指定します。",
                "glomap_exec_browse_tooltip": "GLOMAP実行ファイルを選択します。",
                "glomap_exec_browse_title": "GLOMAP実行ファイルを選択",
                ...
                "glomap_run_button_label": "GLOMAP実行",
                "glomap_run_button_tooltip": "GLOMAPマッパーで処理を開始します。",
                ...
                "log_glomap_exec_selected_format": "GLOMAP実行ファイル選択: {filepath}",
                ...
                "log_glomap_exec_not_found_format": "GLOMAP実行ファイルが見つかりません: {path}",
                "log_colmap_pipeline_start_format": "COLMAP処理開始: Rig={rig_folder}, Matcher={matcher}, Postshot出力={postshot_output}",
                "log_glomap_pipeline_start_format": "GLOMAP処理開始: Rig={rig_folder}, Matcher={matcher}, Postshot出力={postshot_output}",
                ...
                "log_glomap_pipeline_command_format": "GLOMAP CMD: {command}",
                "log_colmap_pipeline_command_failed_format": "COLMAPコマンド失敗 (code {code}): {command}",
                "log_glomap_pipeline_command_failed_format": "GLOMAPコマンド失敗 (code {code}): {command}",
                "log_colmap_pipeline_command_exception_format": "COLMAPコマンド例外: {command} ({error})",
                "log_glomap_pipeline_command_exception_format": "GLOMAPコマンド例外: {command} ({error})",
            ...
            'en': {
                ...
                "glomap_exec_label": "GLOMAP Executable:",
                "glomap_exec_tooltip": "Path to glomap.exe (or glomap).",
                "glomap_exec_browse_tooltip": "Select the GLOMAP executable.",
                "glomap_exec_browse_title": "Select GLOMAP Executable",
                "colmap_preset_label": "Preset:",
                ...
                "glomap_run_button_label": "Run GLOMAP",
                "glomap_run_button_tooltip": "Start the pipeline with the GLOMAP mapper.",
                ...
                "log_glomap_exec_selected_format": "GLOMAP executable selected: {filepath}",
                ...
                "log_glomap_exec_not_found_format": "GLOMAP executable not found: {path}",
                "log_colmap_pipeline_start_format": "COLMAP pipeline start: Rig={rig_folder}, Matcher={matcher}, Postshot output={postshot_output}",
                "log_glomap_pipeline_start_format": "GLOMAP pipeline start: Rig={rig_folder}, Matcher={matcher}, Postshot output={postshot_output}",
                ...
                "log_glomap_pipeline_command_failed_format": "GLOMAP command failed (code {code}): {command}",
                "log_colmap_pipeline_command_exception_format": "COLMAP command exception: {command} ({error})",
                "log_glomap_pipeline_command_exception_format": "GLOMAP command exception: {command} ({error})",
