    ...
    def __init__(self, initial_language='ja'): # デフォルトを 'ja' から initial_language へ変更
        ...
        self._strings = {
            'ja': {
                ...
                "realityscan_preset_insta360_rig_locked": "Insta360 リグ理想 (Locked)",
                "realityscan_preset_rs_exact_compat": "RS Exact互換",
                "realityscan_preset_cli_rewrite": "CLI上書き用",
                "realityscan_preset_poseprior_exact": "PosePrior比較: Exact",
                "realityscan_preset_poseprior_locked": "PosePrior比較: Locked",
                "realityscan_preset_poseprior_unset": "PosePrior比較: 未指定",
                ...
                "realityscan_calibration_prior_tooltip": "exactは固定、lockedは厳密固定、initialは初期値から最適化。未指定は書き出しません。",
                "realityscan_calibration_prior_locked": "Locked (推奨)",
                "realityscan_calibration_prior_exact": "Exact",
                ...
                "realityscan_distortion_model_none": "None (歪みなし)",
                ...
                "realityscan_pose_in_common_label": "Poseを_commonに出力 (フレームから除外)",
                "realityscan_pose_in_common_tooltip": "Rotation/Positionを_common.xmpに書き出し、各フレームXMPからは省きます。",
            ...
            'en': {
                ...
                "realityscan_preset_insta360_rig_locked": "Insta360 Rig Ideal (Locked)",
                "realityscan_preset_rs_exact_compat": "RS Exact Compatible",
                "realityscan_preset_cli_rewrite": "CLI Rewrite",
                "realityscan_preset_poseprior_exact": "PosePrior Compare: Exact",
                "realityscan_preset_poseprior_locked": "PosePrior Compare: Locked",
                "realityscan_preset_poseprior_unset": "PosePrior Compare: Unset",
                "realityscan_preset_custom": "Custom",
                ...
                "realityscan_calibration_prior_label": "Calib Prior:",
                "realityscan_calibration_prior_tooltip": "exact keeps calibration fixed; locked enforces strict fixed; initial optimizes from initial. Unset omits the field.",
                ...
                "realityscan_distortion_model_none": "None",
                "realityscan_distortion_model_division": "Division",
                ...
                "realityscan_pose_in_common_label": "Pose to _common (omit per-frame)",
                "realityscan_pose_in_common_tooltip": "Write Rotation/Position to _common.xmp and omit them from per-frame XMP.",
