    ...
    def __init__(self, initial_language='ja'): # デフォルトを 'ja' から initial_language へ変更
        ...
        self._strings = {
            'ja': {
                ...
                "realityscan_xmp_mode_tooltip": "draft: 位置を調整可能 / exact: 相対位置固定 / locked: 相対+絶対固定。",
                "realityscan_xmp_mode_draft": "Draft",
                "realityscan_xmp_mode_exact": "Exact (推奨)",
                "realityscan_xmp_mode_locked": "Locked",
                "realityscan_coordinates_label": "座標系:",
                "realityscan_coordinates_tooltip": "absoluteは全体座標系、relativeは相対座標系を使用します。",
                "realityscan_coordinates_absolute": "Absolute (推奨)",
                "realityscan_coordinates_relative": "Relative",
                "realityscan_rig_id_mode_label": "Rig ID:",
                "realityscan_rig_id_mode_tooltip": "Autoは変換ごとにGUIDを生成。Manualは入力したGUIDを使用します。",
                "realityscan_rig_id_mode_auto": "Auto (GUID生成)",
                ...
                "realityscan_calibration_prior_tooltip": "lockedはキャリブレーション固定、initialは初期値から最適化。",
                ...
                "realityscan_calibration_group_tooltip": "カメラごと/単一/同一FOVでグループ化。",
                ...
                "realityscan_distortion_model_tooltip": "歪みモデルを指定します。divisionは魚眼向け。",
                "realityscan_distortion_model_division": "Division (推奨)",
                "realityscan_distortion_model_brown3": "Brown3",
            ...
            'en': {
                ...
                "realityscan_xmp_mode_tooltip": "draft: adjustable / exact: fix relative / locked: fix relative+absolute.",
                "realityscan_xmp_mode_draft": "Draft",
                "realityscan_xmp_mode_exact": "Exact (Recommended)",
                "realityscan_xmp_mode_locked": "Locked",
                "realityscan_coordinates_label": "Coordinates:",
                "realityscan_coordinates_tooltip": "absolute uses global coordinates; relative uses relative coordinates.",
                "realityscan_coordinates_absolute": "Absolute (Recommended)",
                "realityscan_coordinates_relative": "Relative",
                "realityscan_rig_id_mode_label": "Rig ID:",
                "realityscan_rig_id_mode_tooltip": "Auto generates a GUID per run; Manual uses the provided GUID.",
                "realityscan_rig_id_mode_auto": "Auto (Generate GUID)",
                "realityscan_rig_id_mode_manual": "Manual",
                "realityscan_rig_instance_label": "Rig Instance:",
                ...
                "realityscan_calibration_prior_label": "Calib Prior:",
                "realityscan_calibration_prior_tooltip": "locked keeps calibration fixed; initial optimizes from initial.",
                "realityscan_calibration_prior_locked": "Locked (Recommended)",
                "realityscan_calibration_prior_initial": "Initial",
                "realityscan_calibration_group_label": "Calib Group:",
                "realityscan_calibration_group_tooltip": "Group by camera / single / same FOV.",
                "realityscan_calibration_group_per_camera": "Per Camera (Recommended)",
                "realityscan_calibration_group_per_fov": "Per FOV",
                "realityscan_calibration_group_single": "Single",
                "realityscan_distortion_model_label": "Distortion:",
                "realityscan_distortion_model_tooltip": "Select a distortion model. division is good for fisheye.",
                "realityscan_distortion_model_division": "Division (Recommended)",
                "realityscan_distortion_model_brown3": "Brown3",
