    ...
    def __init__(self, initial_language='ja'): # デフォルトを 'ja' から initial_language へ変更
        ...
        self._strings = {
            'ja': {
                ...
                "colmap_matcher_tooltip": "sequential: 連番向け。exhaustive: 全組み合わせ（重いが繋がりやすい）。",
            ...
            'en': {
                ...
                "colmap_matcher_label": "Matcher:",
                "colmap_matcher_tooltip": "sequential: for videos. exhaustive: all pairs (slower but connects sessions).",
