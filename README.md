...
> **Migration recommended for 3DGS / SfM workflows:** For photogrammetry, COLMAP, Metashape, or 3D Gaussian Splatting dataset preparation, use the newer and more capable [**STechDrive 3DGS Utils**](https://github.com/stechdrive/stechdrive-3dgs-utils). It integrates frame extraction, review, mask generation, Metashape/COLMAP export, and 3DGS-oriented output workflows in one GUI.
>
...
## Recommended Metashape + 3DGS Workflow

If your goal is a Metashape-based 360° video workflow for 3D Gaussian Splatting, see [stechdrive-3dgs-utils](https://github.com/stechdrive/stechdrive-3dgs-utils).

That workflow keeps extracted frames as equirectangular images for Metashape SfM, generates YOLO/SAM and seam/overexposure masks before alignment, then exports cubemap training images and masks for LichtFeld, Postshot, and Brush.

**[日本語] Metashape + 3DGS 向けの推奨ワークフロー**

Metashape SfM を使って360度動画から3DGS学習データを作る場合は、より簡単で堅牢なワークフローとして [stechdrive-3dgs-utils](https://github.com/stechdrive/stechdrive-3dgs-utils) を利用できます。

抽出フレームをエクイレクタングラー画像のままMetashapeに渡し、SfM前にYOLO/SAMマスクやスティッチ境界/白飛びマスクを生成してから、LichtFeld、Postshot、Brush向けのキューブマップ画像とマスクを書き出します。
